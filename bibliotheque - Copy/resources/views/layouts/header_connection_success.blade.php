...
<head>
    ...
    <link rel="stylesheet" href="{{asset('assets/lib/bootstrap/js/bootstrap.js')}}">
</head>
<header>
    <link rel="stylesheet" href="{{asset('assets/lib/bootstrap/css/welcome.css')}}">
            ...
            <div class="offcanvas-body">
              <ul class="navbar-nav justify-content-end flex-grow-1 pe-3">
                <li class="nav-item d-flex hover_li">
                  ...
                  <li class="nav-item d-flex hover_li">
                    <i class="fas fa-sign-out py-3 px-2 text-primary"></i>
                    <a class="nav-link active text-primary py-2 fs-5" href="{{route('connection')}}">Se deconnecter</a>
                  </li>
              ...
              <form class="d-flex mt-3" role="search">
                <input class="form-control me-2" type="search" placeholder="Rechercher un livre ou une video" aria-label="Search">
